  ...
  return (
    <Link href={`/propiedades/${propiedad.id}`} className="card group hover:shadow-xl transition-shadow duration-300 flex flex-col">
      ...
      <div className="relative h-52 overflow-hidden">
        ...
        {propiedad.destacada && (
          <div className="absolute bottom-3 left-3">
            <span className="text-xs font-semibold px-2 py-1 rounded-full bg-terracota text-tierra flex items-center gap-1">
      ...
      <div className="p-4 flex flex-col flex-1">
        <h3 className="font-serif font-semibold text-tierra text-lg leading-snug mb-1 group-hover:text-verde-vida transition-colors line-clamp-2">
          {propiedad.titulo}
        </h3>
        ...
        <div className="mt-auto">
          <p className="text-2xl font-bold text-verde-vida">
